...
export function buildRecipeInstructions(
  ...
  return [
    ...
    "HEAT-UP TIME BUDGET: Source recipes often give pan/stovetop cooking times after preheating, but Monsieur Cuisine mode durations start with a cold or partly cold jug unless the previous step already heated it. You MUST add heat-up time to cooking durations. For cold 500-1000 g liquid, add about 6-10 min before active steaming/boiling; for 1000-2000 g liquid or dense vegetables, add about 10-15 min. For roast/manualCooking from a cold jug, add 2-5 min for small aromatics and 5-8 min for larger vegetable/meat loads. Do not copy frying-pan or boiling times directly.",
